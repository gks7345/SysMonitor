...
private:
	...
	SnapshotTarget collectTarget(TargetEntry& entry, double elapsedSec);
	SnapshotChildProcess collectChild(ProcessCounters& counters, double elapsedSec);
	...
	static void printSeparator(int width = 64);
	...
	static std::vector<TargetNetConnection> getConnections(DWORD pid);
